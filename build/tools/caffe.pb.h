...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.InterpParameter interp_param = 205;
  inline bool has_interp_param() const;
  inline void clear_interp_param();
  static const int kInterpParamFieldNumber = 205;
...
inline void DetectionOutputParameter::clear_save_file() {
  if (save_file_ != &::google::protobuf::internal::kEmptyString) {
    save_file_->clear();
  }
  clear_has_save_file();
}
...
inline ::std::string* DetectionOutputParameter::release_save_file() {
  ...
  if (save_file_ == &::google::protobuf::internal::kEmptyString) {
    ...
    save_file_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
    return temp;
  }
}
